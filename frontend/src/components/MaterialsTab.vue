    ...
    <ul class="materials-list">
      <li v-for="material in materials" :key="material.id" class="material-item">
        ...
        <div class="actions-cell">
          <button @click="openEditModal(material)" class="action-button edit-button">Edit</button>
          <button @click="openDeleteItemModal(material)" class="action-button delete-button">
            Delete
          </button>
        </div>
      </li>
