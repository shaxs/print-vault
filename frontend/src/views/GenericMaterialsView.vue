...
import GenericMaterialTable from '../components/GenericMaterialTable.vue'
...
const loadMaterials = async () => {
  ...
  try {
    ...
    console.error('Failed to load generic materials:', error)
  } finally {
...
const isFilterActive = computed(() => {
  return activeFilters.material || activeFilters.color_family
})
