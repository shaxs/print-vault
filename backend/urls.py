...
router.register(r'material-features', views.MaterialFeatureViewSet)
router.register(r'materials', views.MaterialViewSet)
router.register(r'material-photos', views.MaterialPhotoViewSet)
router.register(r'filament-spools', views.FilamentSpoolViewSet)
...
router.register(r'projectbomitems', views.ProjectBOMItemViewSet, basename='projectbomitems')
